...
export const Route = createFileRoute("/home/experimentos/cromatografia")({
  component: Cromatografia,
});

function Cromatografia() {
  return (
    <div className="p-10 max-w-4xl mx-auto text-eerie-black">
      ...
      <p className="text-lg mb-6">
        Descubra as cores escondidas em tintas usando papel e água.
      </p>
      ...
      <ol className="space-y-10">
        <li>
          ...
          <div className="bg-neutral-100 min-h-[150px] rounded flex items-center justify-center text-neutral-400">
            [Ilustração aqui]
          </div>
        </li>
        <li>
          ...
          <p>
            Desenhe com canetinha, mergulhe o papel na água e observe a
            separação das cores.
          </p>
          <div className="bg-neutral-100 min-h-[150px] rounded flex items-center justify-center text-neutral-400">
            [Ilustração aqui]
